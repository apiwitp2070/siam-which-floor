export const UI_TEXT = {
  ...
  subtitle: { en: "Which Floor?", th: "ขึ้นฝั่งไหน ?" },
  destinationLabel: { en: "Destination station", th: "สถานีปลายทาง" },
  searchPlaceholder: {
    en: "Try Asok, Bang Wa...",
    th: "ลองพิมพ์ อโศก บางหว้า…",
  },
  ...
  siteAuthor: { en: "By apiwit", th: "By apiwit" },
} as const;
